...
int aes_cbc_encrypt_full(const unsigned char *userKey, int klen, const unsigned char* in, int length, unsigned char* out, int *pout_length);
int aes_cbc_decrypt_full(const unsigned char *userKey, int klen, const unsigned char* in, int length, unsigned char* out, int *pout_length);
