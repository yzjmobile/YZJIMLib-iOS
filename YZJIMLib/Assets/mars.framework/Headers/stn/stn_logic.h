...
namespace stn{
    ...
    public:
		...
		/// error_code
		/// 0=成功
		/// 1=session_id 本地错误 description=errorCode
		/// 2=login 返回错误 description=JSON
		/// 3=login 本地错误 description=errorCode
		...
		//#endif
		//		};
		virtual int OnOpenSession(int error_code, const std::string& description) {return 0;}
#endif
...
//    extern void SetShortlinkSvrAddr(const uint16_t port);
	...
	extern std::string(*GetCurrentLonglinkIp)();
	extern void(*ClearCmds)();
#endif
